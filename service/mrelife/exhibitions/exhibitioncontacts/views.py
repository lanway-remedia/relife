...
class ExhibitionContactViewSet(viewsets.ModelViewSet):
    ...
    def retrieve(self, request, pk=None):
        try:
            ...
            return Response(CommonFuntion.resultResponse(False, "", MessageCode.EXC002.value, e), status=status.HTTP_404_NOT_FOUND)
    ...
    def create(self, request):
        try:
            ...
            if serializer.is_valid():
                ...
                return Response(CommonFuntion.resultResponse(True, serializer.data, MessageCode.EXC003.value, ""), status=status.HTTP_201_CREATED)
            return Response(CommonFuntion.resultResponse(False, "", MessageCode.EXC004.value, serializer.errors), status=status.HTTP_400_BAD_REQUEST)
        except Exception as e:
            return Response(CommonFuntion.resultResponse(False, "", MessageCode.EXC004.value, e), status=status.HTTP_400_BAD_REQUEST)
    ...
    def update(self, request, pk=None):
        try:
            ...
            return Response(CommonFuntion.resultResponse(False, "", MessageCode.EXC006.value, serializer.errors), status=status.HTTP_400_BAD_REQUEST)
        except Exception as e:
            return Response(CommonFuntion.resultResponse(False, "", MessageCode.EXC006.value, e), status=status.HTTP_400_BAD_REQUEST)
    ...
    def destroy(self, request, pk=None):
        try:
            ...
            return Response(CommonFuntion.resultResponse(False, "", MessageCode.EXC008.value, serializer.errors), status=status.HTTP_400_BAD_REQUEST)
        except Exception as e:
            return Response(CommonFuntion.resultResponse(False, "", MessageCode.EXC008.value, e), status=status.HTTP_400_BAD_REQUEST)
