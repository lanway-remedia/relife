...
class ExhibitionSerializer(serializers.ModelSerializer):
    ...
    start_time = serializers.DateField(input_formats=['%Y-%m-%d', ], format="%d-%m-%Y", required=True)
    end_time = serializers.DateField(input_formats=['%Y-%m-%d', ], format="%d-%m-%Y", required=True)
