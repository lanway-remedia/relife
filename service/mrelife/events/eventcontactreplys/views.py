...
from mrelife.events.eventcontactreplys.serializers import EventContactReplySerializer
...
class EventContactReplyViewSet(viewsets.ModelViewSet):
    ...
    def retrieve(self, request, pk=None):
        try:
            queryset = EventContactReply.objects.all()
    ...
    def update(self, request, pk=None):
        try:
            ...
            serializer = EventContactReplySerializer(event_obj, data=request.data)
            if serializer.is_valid():
