...
from mrelife.events.eventmodelhouses.serializers import EventModelHouseSerializer
...
class EventModelhouseViewSet(viewsets.ModelViewSet):
    ...
    def retrieve(self, request, pk=None):
        try:
            queryset = EventModelHouse.objects.all()
    ...
    def update(self, request, pk=None):
        try:
            ...
            serializer = EventModelHouseSerializer(event_obj, data=request.data)
            if serializer.is_valid():
