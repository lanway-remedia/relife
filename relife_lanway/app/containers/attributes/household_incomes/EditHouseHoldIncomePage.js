...
class EditHouseHoldIncomePage extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      data: [],
  ...
  componentDidMount() {
    ...
    this.props.attributeHouseIncomeGetRequest(id)
  }
  ...
  componentWillReceiveProps(nextProps) {
    if (this.props.data != nextProps.data) {
      ...
      if (response.data === undefined || response.data.length === 0) {
        ...
        this.props.history.replace('/manage-household-income-list')
      } else {
        if (response.isGetId)
          this.setState({
            data: response.data,
  ...
  handleSubmit = e => {
    ...
    this.props.attributeHouseIncomeEditRequest(data)
...
EditHouseHoldIncomePage.propTypes = {
  history: PropTypes.object,
  match: PropTypes.object,
  processing: PropTypes.bool,
  attributeHouseIncomeGetRequest: PropTypes.func,
  attributeHouseIncomeEditRequest: PropTypes.func,
...
const mapDispatchToProps = dispatch => ({
  attributeHouseIncomeGetRequest: data =>
    dispatch(AttributeActions.attributeHouseIncomeGetRequest(data)),
  attributeHouseIncomeEditRequest: data =>
    dispatch(AttributeActions.attributeHouseIncomeEditRequest(data))
})

export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withRouter(EditHouseHoldIncomePage))
