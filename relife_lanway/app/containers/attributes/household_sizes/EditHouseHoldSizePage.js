...
class EditHouseHoldSizePage extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      data: [],
  ...
  componentDidMount() {
    ...
    this.props.attributeHouseSizeGetRequest(id)
  }
  ...
  handleSubmit = e => {
    ...
    this.props.attributeHouseSizeEditRequest(data)
...
EditHouseHoldSizePage.propTypes = {
  history: PropTypes.object,
  match: PropTypes.object,
  processing: PropTypes.bool,
  attributeHouseSizeGetRequest: PropTypes.func,
  attributeHouseSizeEditRequest: PropTypes.func,
...
const mapDispatchToProps = dispatch => ({
  attributeHouseSizeGetRequest: data =>
    dispatch(AttributeActions.attributeHouseSizeGetRequest(data)),
  attributeHouseSizeEditRequest: data =>
    dispatch(AttributeActions.attributeHouseSizeEditRequest(data))
})

export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withRouter(EditHouseHoldSizePage))
