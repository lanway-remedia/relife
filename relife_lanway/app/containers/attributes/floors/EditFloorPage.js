...
class EditContructionPage extends React.Component {
  ...
  componentDidMount() {
    ...
    this.props.attributeFloorGetRequest(id)
  }
  ...
  handleSubmit = e => {
    ...
    this.props.attributeFloorEditRequest(data)
...
EditContructionPage.propTypes = {
  ...
  attributeFloorGetRequest: PropTypes.func,
  attributeFloorEditRequest: PropTypes.func,
...
const mapDispatchToProps = dispatch => ({
  attributeFloorGetRequest: data =>
    dispatch(AttributeActions.attributeFloorGetRequest(data)),
  attributeFloorEditRequest: data =>
    dispatch(AttributeActions.attributeFloorEditRequest(data))
})
