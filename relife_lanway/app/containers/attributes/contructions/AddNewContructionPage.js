...
class AddNewContructionPage extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      data: [],
  ...
  render() {
    return (
      <Container fluid className="add-new-attribute">
        <Helmet>
          <title>{I18nUtils.t('att-cons-add-page-title')}</title>
        </Helmet>
        <div className="page-title">
          <h1>
            <i className="fa fa-signal" aria-hidden="true" />
            {I18nUtils.t('att-cons-add-page-title')}
          </h1>
        </div>
        <ValidationForm
...
AddNewContructionPage.propTypes = {
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withRouter(AddNewContructionPage))
