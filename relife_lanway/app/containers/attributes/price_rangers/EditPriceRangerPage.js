...
class EditPriceRangerPage extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      data: [],
  ...
  componentDidMount() {
    ...
    this.props.attributePriceGetRequest(id)
  }
  ...
  handleSubmit = e => {
    ...
    this.props.attributePriceEditRequest(data)
...
EditPriceRangerPage.propTypes = {
  history: PropTypes.object,
  match: PropTypes.object,
  processing: PropTypes.bool,
  attributePriceGetRequest: PropTypes.func,
  attributePriceEditRequest: PropTypes.func,
...
const mapDispatchToProps = dispatch => ({
  attributePriceGetRequest: data =>
    dispatch(AttributeActions.attributePriceGetRequest(data)),
  attributePriceEditRequest: data =>
    dispatch(AttributeActions.attributePriceEditRequest(data))
})

export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withRouter(EditPriceRangerPage))
