        ...
        <ModalBody className={bodyClass}>
          ...
          {okFunction && (
            <div className="modal-btns">
              <Button color="secondary" className="btn-cancel" onClick={okFunction}>
                {I18nUtils.t('ok')}
              </Button>
          ...
          {deleteFunction && (
            <div className="modal-btns">
              <Button color="secondary" className="btn-cancel" onClick={deleteFunction}>
                {I18nUtils.t('delete')}
              </Button>
              <Button color="success" className="btn-default" onClick={handleHide}>
                {I18nUtils.t('cancel')}
          ...
          {closeFunction && (
            <div className="modal-btns">
              <Button color="success" className="btn-default" onClick={closeFunction}>
                {I18nUtils.t('close')}
              </Button>
            </div>
          )}
